    ...
    <div className="mb-5 bg-slate-300">
      <div className="mx-auto flex w-full max-w-7xl justify-between p-3">
        <div className="flex space-x-4">
          ...
          {isUserLoggedIn && (
            <PageLink className="p-2 hover:rounded-md hover:bg-slate-400" href="/profile">
              Profile
            </PageLink>
          )}
        </div>
        <div className="flex space-x-4">
          {!isUserLoggedIn ? (
            <>
              <PageLink className="p-2 hover:rounded-md hover:bg-slate-400" href="/login">
                Log In
              </PageLink>
              <PageLink className="p-2 hover:rounded-md hover:bg-slate-400" href="/signup">
                Sign Up
              </PageLink>
            </>
          ) : (
